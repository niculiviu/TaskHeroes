...
app.config(['$routeProvider', function ($routeProvider) {
    ...
    $routeProvider.when('/admin/members/', { templateUrl: 'static/members.html', controller: 'adminCtrl' });
    ...
    $routeProvider.when('/admin/project/:ID/', { templateUrl: 'static/project.html', controller: 'adminCtrl' });
    $routeProvider.when('/admin/settings/', { templateUrl: 'static/settings.html', controller: 'adminCtrl' });
